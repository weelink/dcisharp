...
namespace dcisharp.Experiments.Mapping
{
    public class Account : Role<Account, TransferMoneySource>, Role<Account, TransferMoneyDestination>
    {
        ...
        public ContextMapping<Account, TransferMoneySource> MapContext(
            ContextMapping<Account, TransferMoneySource> mapping)
        {
            return
                mapping
        ...
        public ContextMapping<Account, TransferMoneyDestination> MapContext(
            ContextMapping<Account, TransferMoneyDestination> mapping)
        {
            return
                mapping
